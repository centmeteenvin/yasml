  ...
  group('Future Query Execution', () {
    test('AchievementsQuery loads achievements asynchronously', () async {
      ...
      QueryEventValidators.validateContainerCreated(createdEvent,
          key: 'Achievements', reason: 'New Listerner');
      ...
      QueryEventValidators.validateNewListener(newListenerEvent,
          key: 'Achievements', listenerType: MockQueryListener);
      ...
      QueryEventValidators.validateSetState(setStateEvent,
          ...
          stateValidator: (state) =>
              AsyncValueValidators.isAsyncDataWith<List<Achievement>>(state, (data) =>
                  data.length == 4 &&
      ...
      QueryEventValidators.validateContainerDisposed(disposedEvent,
          key: 'Achievements', reason: 'No Listeners');
